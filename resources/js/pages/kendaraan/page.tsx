...
export default function KendaraanPage() {
  ...
  const onSubmit = () => {
    if (editing) {
      ...
      setData((prev) => prev.map((r) => (r.id_kendaraan === editing.id_kendaraan ? form : r)))
      toast({ title: "Data berhasil disimpan", description: "Perubahan kendaraan telah disimpan." })
    } else {
      console.log("[CREATE KENDARAAN]", form)
      setData((prev) => [
        { ...form, id_kendaraan: form.id_kendaraan || `K-${String(prev.length + 1).padStart(3, "0")}` },
        ...prev,
      ])
      toast({ title: "Data berhasil disimpan", description: "Kendaraan baru telah ditambahkan." })
    }
    setOpen(false)
  }
  ...
  const onDelete = (row: Kendaraan) => {
    ...
    setData((prev) => prev.filter((r) => r.id_kendaraan !== row.id_kendaraan))
    toast({ title: "Data berhasil dihapus", description: `Kendaraan ${row.id_kendaraan} dihapus.` })
  }
  ...
  return (
    <div className="space-y-4">
                  ...
                  <TableRow key={row.id_kendaraan}>
                    <TableCell>
                      <div className="relative h-10 w-16 rounded-md overflow-hidden bg-muted">
                        <Image
                          src={row.foto_kendaraan || `/placeholder.svg?height=40&width=64&query=foto%20kendaraan`}
                    ...
                    <TableCell>{row.id_kendaraan}</TableCell>
                    <TableCell>{row.nomor_polisi}</TableCell>
                    <TableCell>{row.merk}</TableCell>
                    <TableCell>{row.tipe}</TableCell>
                    <TableCell>{row.tahun_pembuatan}</TableCell>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Tindakan ini tidak dapat dibatalkan. Kendaraan {row.id_kendaraan} akan dihapus.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
      ...
      <FormModal
        title={editing ? `Ubah Kendaraan ${editing.id_kendaraan}` : "Tambah Kendaraan"}
        open={open}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="grid gap-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, id_kendaraan: e.target.value })}
          ...
          <div className="grid gap-2">
            ...
            <Input id="merk" value={form.merk} onChange={(e) => setForm({ ...form, merk: e.target.value })} />
          </div>
          <div className="grid gap-2">
            <Label htmlFor="tipe">Tipe</Label>
            <Input id="tipe" value={form.tipe} onChange={(e) => setForm({ ...form, tipe: e.target.value })} />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <Input id="warna" value={form.warna} onChange={(e) => setForm({ ...form, warna: e.target.value })} />
          </div>
          <div className="grid gap-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, nomor_rangka: e.target.value })}
            />
          </div>
          <div className="grid gap-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, nomor_mesin: e.target.value })}
            />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, foto_kendaraan: e.target.value })}
